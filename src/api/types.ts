...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  api = {
    ...
    individualSealAssignmentsDetail: (assignmentId: string, params: RequestParams = {}) =>
      this.request<AssignmentResponseSuccessApiResponse, ErrorApiResponse | ProblemDetails>({
    ...
    notificationsChannelsList: (params: RequestParams = {}) =>
      this.request<ChannelResponseICollectionSuccessApiResponse, ErrorApiResponse>({
    ...
    devicesIndividualDetail: (deviceId: number, params: RequestParams = {}) =>
      this.request<IndividualDeviceResponseFromDevicePageSuccessApiResponse, ErrorApiResponse | ProblemDetails>({
