...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  api = {
     ...
     * @secure
     */
    mvituIntegrationsCreateOrUpdateCreate: (data: IntegrationInfoRequest, params: RequestParams = {}) =>
      this.request<void, ErrorApiResponse>({
     ...
     * @secure
     */
    mvituIntegrationsChangeStatusCreate: (data: ChangeStatusRequest, params: RequestParams = {}) =>
      this.request<void, ErrorApiResponse>({
     ...
     * @secure
     */
    mvituNodesChangeStatusCreate: (nodeId: number, data: ChangeStatusRequest, params: RequestParams = {}) =>
      this.request<void, ErrorApiResponse>({
