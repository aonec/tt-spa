...
> extends HttpClient<SecurityDataType> {
    api = {
        ...
        apartmentsList: (
            ...
            this.request<
                ApartmentPagedListSuccessApiResponse,
                ErrorApiResponse
            >({
                path: `/api/Apartments`,
                method: 'GET',
        ...
        contractorsList: (params: RequestParams = {}) =>
            this.request<
                PagedContractorResponseSuccessApiResponse,
                ErrorApiResponse
            >({
        ...
        contractorsCreate: (
            ...
            this.request<
                ContractorResponseSuccessApiResponse,
                ErrorApiResponse
            >({
                path: `/api/Contractors`,
                method: 'POST',
        ...
        homeownersCreate: (
            ...
            this.request<
                HomeownersResponseSuccessApiResponse,
                ErrorApiResponse
            >({
                path: `/api/Homeowners`,
                method: 'POST',
        ...
        housingStocksCreate: (
            ...
            this.request<
                HousingStockResponseSuccessApiResponse,
                ErrorApiResponse
            >({
        ...
        individualDevicesList: (
            ...
            this.request<
                IndividualDeviceListResponsePagedListSuccessApiResponse,
                ErrorApiResponse
            >({
        ...
        managingFirmsCurrentList: (params: RequestParams = {}) =>
            this.request<
                ManagementFirmResponseSuccessApiResponse,
                ErrorApiResponse
            >({
        ...
        managingFirmUsersList: (
            query?: { RoleNames?: string[] | null },
            params: RequestParams = {}
        ) =>
            this.request<
                PagedManagingFirmUserResponseSuccessApiResponse,
                ErrorApiResponse
            >({
         ...
         *
         * @tags Nodes
         * @name NodesInitNodesList
         * @request GET:/api/Nodes/initNodes
         * @secure
         */
        nodesInitNodesList: (params: RequestParams = {}) =>
            this.request<void, any>({
                path: `/api/Nodes/initNodes`,
                method: 'GET',
                secure: true,
                ...params,
            }),
        ...
        tasksCreateCreate: (
            ...
            this.request<
                TaskCreateResponseSuccessApiResponse,
                ErrorApiResponse
            >({
        ...
        tasksCommentsCreate: (
            ...
            this.request<
                TaskCommentResponseSuccessApiResponse,
                ErrorApiResponse
            >({
