...
const AddDeviceForm = (props) => {
    ...
    useEffect(() => {
        ...
        console.log('pipeNumbers', pipeNumbers.includes(values.pipeNumber));
        if (pipeNumbers.includes(values.pipeNumber)) {
            ...
            const hasFlowMeter = _.find(getDevices.devices, {housingMeteringDeviceType: 'FlowMeter'});
            const hasThermoSensor = _.find(getDevices.devices, {housingMeteringDeviceType: 'ThermoSensor'});
            console.log('hasFlowMeter', hasFlowMeter);
            hasFlowMeter ? console.log('на трубе есть расходомер') : console.log('на трубе нет расходомер')
            hasThermoSensor ? console.log('на трубе есть датчик') : console.log('на трубе нет датчика')
        }
    }, [values.pipeNumber]);
