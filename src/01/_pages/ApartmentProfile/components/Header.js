...
const UL = styled.ul`
  position: absolute;
  right: 0;
  filter: drop-shadow(0px 4px 4px rgba(78, 93, 146, 0.16)), drop-shadow(0px 8px 16px rgba(78, 93, 146, 0.08));
  ...
  return (
    <HeaderWrap>
      ...
      <div style={{ position: 'relative' }}>
        ...
        <EditButton onClick={editButtonHandler}><MoreOutlined /></EditButton>
        <Popup visible='false' />
      </div>
