...
export const ModalODPU = ({ device }) => {
    ...
    const downloadReport = () => {
        ...
        if (entryNumberRes.current) {
            ...
            }&pipenumber=${pipeNumberRes.current}&from=${convertDateOnly(
                begin
            ...
            const template =
                'http://84.201.132.164:8080/api/reports/xlsx?deviceId=1510&ereporttype=daily&resourcetype=heat&entrynumber=1&from=2020-08-15T00:00:00Z&to=2020-08-25T00:00:00Z'
            const template2 =
