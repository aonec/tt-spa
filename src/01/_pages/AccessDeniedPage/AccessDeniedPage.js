...
export const AccessDeniedPage = () => styled(button)(
  <div className="access-denied">
    <h1 className="access-denied__title title-40 white">У вас нет доступа к запрашиваемым ресурсам</h1>
    <p className="access-denied__subtitle ft-14">
      Если вы уверены, что это ошибка или недоразумение, то, пожалуйста, напишите нам в
