...
export const setLowerDiameterRange = (lowerDiameterRange) => ({
    type: SET_LOWER_DIAMETER_RANGE,
    lowerDiameterRange,
})
export const setUpperDiameterRange = (upperDiameterRange) => ({
    type: SET_UPPER_DIAMETER_RANGE,
    upperDiameterRange,
})
