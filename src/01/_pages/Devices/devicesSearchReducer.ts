...
const devicesSearchReducer =
  (state: Partial<DeviceSearchReducerStateType>, action: DeviceSearchActionTypes): Partial<DeviceSearchReducerStateType> => {
      switch (action.type) {
          case DevicesSearchActions.SET_SEARCHTERM:
              return { ...state, searchTerm: (action as SetSearchTermInterface).searchTerm }

          case DevicesSearchActions.SET_EXPIRATION_DATE:
              return { ...state, expirationDate: (action as SetExpirationDateInterface).expirationDate }

          case DevicesSearchActions.SET_LOWER_DIAMETER_RANGE:
              return { ...state, lowerDiameterRange: (action as SetLowerDiameterRange).lowerDiameterRange }

          case DevicesSearchActions.SET_UPPER_DIAMETER_RANGE:
              return { ...state, upperDiameterRange: (action as SetUpperDiameterRangeInterface).upperDiameterRange }
          ...
          case DevicesSearchActions.SET_DEVICES_FILTER:
              switch ((action as SetDevicesFilterInterface).filterParameter) {
                  ...
                  default: throw new Error('Нет такого параметра!')
              }
...
export const setExpirationDate = (expirationDate: string):SetExpirationDateInterface => ({
...
export const setLowerDiameterRange = (lowerDiameterRange: string): SetLowerDiameterRange => ({
...
export const setUpperDiameterRange = (upperDiameterRange: string): SetUpperDiameterRangeInterface => ({
...
export const setDevicesFilter = (filterParameter: FilterParameterType): SetDevicesFilterInterface => ({
