...
const FormEditODPU = (props) => {
    const { currentTabKey, device, calculators, setTab } = props
    ...
    const {
        ...
        initialValues: {
            ...
            lastCheckingDate:
                lastCheckingDate === null ? null : moment(lastCheckingDate),
            futureCheckingDate:
                futureCheckingDate === null ? null : moment(futureCheckingDate),
            lastCommercialAccountingDate:
        ...
        <div style={{ maxWidth: '480px' }}>
            ...
            >
                ...
                <div hidden={Number(currentTabKey) !== 2}>
                    ...
                    <Form.Item label="Выберите вычислитель, к которому подключен прибор">
                        <SelectTT
                            name="calculatorId"
                ...
                <div style={{ padding: '32px 0' }}>
                    ...
                    <NavLink to={`/housingMeteringDevices/${deviceId}/`}>
                        <ButtonTT style={{ marginLeft: '16px' }} color="white">
                            Отмена
                        </ButtonTT>
                    </NavLink>
                </div>
