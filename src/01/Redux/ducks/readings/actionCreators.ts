import {
    ...
    SetInputFocusedActionType, SetInputUnfocusedActionType,
...
export const updateReadings = (deviceId: number, readingNumber: number, readingValue: number): UpdateReadingsActionType => {
    return { type: ReadingsActionsType.UPDATE_READINGS, deviceId, readingNumber, readingValue }
}
export const setInputFocused = (deviceId: number): SetInputFocusedActionType => {
